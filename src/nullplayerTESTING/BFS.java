            ...
            switch (idx) {
                ...
                case 26:
                    ...
                    if(seen.charAt(42) == '0') {
                        ...
                        else Queue.queuePush(42 | (first << 3) | second);
                    }
                    break;
                case 27:
                    if(seen.charAt(23) == '0') {
                ...
                case 30:
                    ...
                    if(seen.charAt(48) == '0') {
                        ...
                        else Queue.queuePush(48 | (first << 3) | second);
                    }
                    break;
                case 31:
                    if(seen.charAt(29) == '0') {
                    ...
                    if(seen.charAt(49) == '0') {
                        ...
                        else Queue.queuePush(49 | (first << 3) | second);
                    }
                    break;
                case 32:
                    if(seen.charAt(30) == '0') {
                    ...
                    if(seen.charAt(50) == '0') {
                        ...
                        else Queue.queuePush(50 | (first << 3) | second);
                    }
                    break;
                case 33:
                    if(seen.charAt(31) == '0') {
                    ...
                    if(seen.charAt(51) == '0') {
                        ...
                        else Queue.queuePush(51 | (first << 3) | second);
                    }
                    break;
                case 34:
                    if(seen.charAt(32) == '0') {
                ...
                case 35:
                    ...
                    if(seen.charAt(55) == '0') {
                        ...
                        else Queue.queuePush(55 | (first << 3) | second);
                    }
                    break;
                case 36:
                    if(seen.charAt(36) == '0') {
                    ...
                    if(seen.charAt(56) == '0') {
                        ...
                        else Queue.queuePush(56 | (first << 3) | second);
                    }
                    break;
                case 37:
                    if(seen.charAt(37) == '0') {
                    ...
                    if(seen.charAt(57) == '0') {
                        ...
                        else Queue.queuePush(57 | (first << 3) | second);
                    }
                    break;
                case 38:
                    if(seen.charAt(38) == '0') {
                    ...
                    if(seen.charAt(58) == '0') {
                        ...
                        else Queue.queuePush(58 | (first << 3) | second);
                    }
                    break;
                case 39:
                    if(seen.charAt(39) == '0') {
                    ...
                    if(seen.charAt(59) == '0') {
                        ...
                        else Queue.queuePush(59 | (first << 3) | second);
                    }
                    break;
                case 40:
                    if(seen.charAt(40) == '0') {
