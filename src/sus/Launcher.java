...
public class Launcher extends Robot
{
    ...
    public void run() throws GameActionException
    {
        ...
        boolean shouldMove = (dist%3 != 2-(rc.getRoundNum()/3)%3);
        ...
        if (mini < sl && lowerCount < 9) {
            ...
            {
                Direction tmp = movement.tryMove(rc, oppositeLoc, prevDirection);
                if (tmp == null) tmp = Direction.CENTER;
                MapLocation possLoc = rc.getLocation().add(tmp);
