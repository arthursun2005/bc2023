...
public class Launcher extends Robot
{
    ...
    public void run() throws GameActionException
    {
        ...
        if (rc.getLocation().distanceSquaredTo(oppositeLoc)*3<=rc.getLocation().distanceSquaredTo(parentLoc)) {
            crossed = true;
        }
        ...
        if (mini<rc.getID() && lowerCount<9) {
            ...
            if (crossed) moveRandom();
            else moveTo(oppositeLoc);
        }
        // tryProtect();
