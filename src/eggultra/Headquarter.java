...
//                    System.out.println(closest + " " + temp + " " + ideal);
    ...
    static int ampCooldown = 0;

    public void run() throws GameActionException
    {
        Tracker.updateWells();
        Tracker.clearEnemyGroups();
        ...
        if (rc.getRoundNum() >= 80 && ada >= 45 && mana >= 45 && ampCooldown <= 0 && rc.getMapHeight() > 22 && rc.getMapWidth() > 22) {
